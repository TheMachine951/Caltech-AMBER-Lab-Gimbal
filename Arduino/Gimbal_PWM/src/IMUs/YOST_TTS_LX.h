...
#include "IMUAbstract.h"
	...
	public:
		...
		struct CONFIG
		{
			...
			//float quadOffset[4]           = {1, 0, 0, 0};
			float quadOffset[4]           = {0.707106781186548, 0.707106781186548, 0, 0};
		};
    ...
    const int32_t pinATT_;
		...
		bool checkConsistancy(const FUSIONED_DATA data);
		void setOffset(float quat[]);
	};
